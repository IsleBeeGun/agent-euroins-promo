...
},{"./dist/inputmask":"../node_modules/inputmask/dist/inputmask.js"}],"js/forms-logic.js":[function(require,module,exports) {
"use strict";
...
var inputMaskPhone = new _inputmask.default('+7 (999) 999-99-99');
var inputMaskDayMonth = new _inputmask.default('9{1,2}');
var inputMaskYear = new _inputmask.default('9999'); // Regular Expressions
...
var validateField = function validateField(event) {
  ...
  if (target.name == 'day') {
    ...
    inputMaskDayMonth.mask(target); // reset if wrong
  ...
  if (target.name == 'year') {
    ...
    inputMaskYear.mask(target); // reset if wrong

    if (+target.value <= 1917 || +target.value > new Date().getFullYear() - 18) {
...
var handleFormByID = function handleFormByID(id) {
  ...
  phone.addEventListener('input', validateField); // -- Day handling

  var day = form.elements.namedItem('day');
  day.addEventListener('input', validateField); // -- Month handling

  var month = form.elements.namedItem('month');
  month.addEventListener('input', validateField); // -- Year handling

  var year = form.elements.namedItem('year');
  year.addEventListener('input', validateField); // - Handling submit action
...
},{"inputmask":"../node_modules/inputmask/index.js"}],"js/promo-main.js":[function(require,module,exports) {
"use strict";
