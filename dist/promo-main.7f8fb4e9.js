...
var REGEX_YEAR = /^[0-9]{4}$/; // Validation (suitable for all fields)
...
var validateField = function validateField(event) {
  ...
  if (target.name == 'phone') {
    // color validation
    REGEX_PHONE.test(target.value) ? setCssValid(target) : setCssInvalid(target); // input mask

    inputMaskPhone = (0, _imask.default)(target, inputMaskPhoneOptions);
  }
  ...
  if (target.name == 'day') {
    ...
    inputMaskDay = (0, _imask.default)(target, inputMaskDayMonthOptions); // reset if wrong
  ...
  if (target.name == 'month') {
    ...
    inputMaskMonth = (0, _imask.default)(target, inputMaskDayMonthOptions); // reset if wrong
  ...
  if (target.name == 'year') {
    ...
    inputMaskYear = (0, _imask.default)(target, inputMaskYearOptions); // reset if wrong
...
var handleFormByID = function handleFormByID(id) {
  ...
  name.addEventListener('blur', validateField); // -- Phone handling

  var phone = form.elements.namedItem('phone');
  phone.addEventListener('input', validateField);
  phone.addEventListener('blur', validateField); // -- Day handling

  var day = form.elements.namedItem('day');
  day.addEventListener('input', validateField);
  day.addEventListener('blur', validateField); // -- Month handling

  var month = form.elements.namedItem('month');
  month.addEventListener('input', validateField);
  month.addEventListener('blur', validateField); // -- Year handling

  var year = form.elements.namedItem('year');
  year.addEventListener('input', validateField);
  year.addEventListener('blur', validateField); // - Handling submit action

  form.addEventListener('submit', function (event) {
    event.preventDefault();

    if (!REGEX_NAME.test(name.value) || !REGEX_PHONE.test(phone.value) || !REGEX_YEAR.test(year.value)) {
...
},{"imask":"../node_modules/imask/esm/index.js"}],"js/promo-main.js":[function(require,module,exports) {
"use strict";
...
var formMobile = (0, _formsLogic.handleFormByID)('form-mobile');
var burger = document.querySelector('#burger');
burger.addEventListener('click', function () {
  var links = document.querySelector('#burger-links');
...
},{"../styles/promo-main.scss":"styles/promo-main.scss","./forms-logic":"js/forms-logic.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
